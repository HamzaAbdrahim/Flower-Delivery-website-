...
const Reasetcode = () => {
  return (
    <div className={`fixed z-[80] w-full lg:w-[45.125rem] hidden  h-[45rem] pt-20 pb-10 px-20 bottom-5  left-1/2 transform -translate-x-1/2 bg-white shadow-2xl duration-500 ease-in `}>
